...
export function CategoryFilterMobile({allCategory,scrollableCategories,counts={},active,onSelect}:Props){
  const items=allCategory?[allCategory,...scrollableCategories]:scrollableCategories;
