...
export const FALLBACK_IDEAS:HubIdea[]=[
  {
    ...
    title:"Ramos premium",
    label:"Mayor ticket",
    description:"Combina papel coreano, cajas y detalles para crear arreglos con mayor valor percibido.",
  ...
  },
  {
    ...
    label:"Alto margen",
    description:"Ideas elegantes para empresas, fechas institucionales y clientes que buscan presentación profesional.",
  ...
  },
  {
    ...
    label:"Inicio rápido",
    description:"Una combinación base para empezar a vender regalos con bajo inventario y buena rotación.",
