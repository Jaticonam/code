...
import { ArrowRight, BarChart3, BookOpen, CalendarDays, FlaskConical } from "lucide-react";
...
export default function GrowthCenterSection(){
  return(
    <section className="growth-center-section">
      <div className="growth-center-heading">
        <span><BarChart3 size={16}/> CENTRO DE CRECIMIENTO EMPRESARIAL WOOLY</span>
        <h2>Aprende, crece y vende más</h2>
        <div className="growth-center-line"/>
        <p>
          Guías, estrategias, tendencias y oportunidades para emprendedores
          que quieren comprar mejor, vender más y construir negocios sostenibles.
        </p>
      </div>
      ...
      <div className="growth-center-grid">
        {GROWTH_ITEMS.map((item,index)=>{
          ...
          return(
            <article key={item.title} className="growth-center-card">
              <div className="growth-center-icon"><Icon size={24}/></div>
      ...
      <div className="growth-center-action">
        <Link to="/blog">
