  ...
  return (
    <div className="grid grid-cols-2 gap-1 px-2 md:grid-cols-3 md:gap-2 md:px-0 xl:grid-cols-5 xl:gap-3">
      {Array.from({ length: 10 }).map((_, i) => (
        <div
          key={i}
          className="rounded-[22px] border border-[#e2e8f0] bg-white p-2.5 shadow-[0_8px_22px_rgba(15,23,42,.06)] md:p-3"
        >
          ...
          <div className="catalog-skeleton mx-auto mb-2 h-3 w-[70%] rounded" />
